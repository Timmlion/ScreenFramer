...
import { Download, Monitor, Layout, Maximize, Droplet, Coffee } from 'lucide-react';
import { EditorConfig, WindowStyle, AspectRatio } from '../../utils/types';
      ...
      <div className="p-6 space-y-8">
        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-2 gap-2">
            {(['mac-dark', 'mac-light', 'win', 'none'] as WindowStyle[]).map((style) => (
              <button
                key={style}
